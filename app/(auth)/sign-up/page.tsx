...
export default function SignupPage() {
  ...
  return (
    <motion.div
      className="w-full max-w-md mx-auto bg-blue-100 border-2 p-6 rounded-2xl shadow-lg space-y-4 animate-in fade-in slide-in-from-bottom-6 relative overflow-hidden"
    ...
    >
      ...
      style={{
        background:
        "radial-gradient(circle at 20% 30%, #3b82f6 0%, transparent 70%), radial-gradient(circle at 80% 70%, #60a5fa 0%, transparent 70%)",
        filter: "blur(32px)",
      }}
      />
      <ToastContainer
      ...
      <div>
        <label
        htmlFor="fullName"
        className="block text-sm font-medium text-gray-700 mb-1 z-10"
        >
        Full Name
        </label>
        <Input
      ...
      <div className="text-center font-bold text-blue-500 z-10">OR</div>

      <div className="text-center z-10">
      <GoogleLoginButton />
      </div>

      <hr className="border-1 z-10" />

      <div className="text-center text-sm text-gray-700 z-10">
      <p>
