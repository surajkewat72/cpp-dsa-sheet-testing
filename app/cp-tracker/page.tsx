    ...
    <div>
      <div className="min-h-screen bg-white dark:bg-background text-gray-900 dark:text-white px-4 md:px-12 py-24 transition-colors duration-300">
        ...
        >
          ...
          <div className="mt-2 w-32 h-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mx-auto" />
        ...
        >
          {/* Easy */}
          <div className="bg-gradient-to-br from-green-500/10 to-green-600/5 dark:from-green-500/20 dark:to-green-600/10 border border-green-500/20 dark:border-green-500/30 rounded-xl p-6 shadow-md hover:shadow-xl hover:scale-[1.02] transition-all duration-300 min-h-[160px]">
            <div className="flex items-center justify-between mb-4">
              <div className="w-3 h-3 rounded-full bg-green-500" />
              <span className="text-sm text-gray-600 dark:text-gray-400 font-medium">Solved Easy</span>
            </div>
            <div className="text-3xl font-bold text-green-600 dark:text-green-400">{combinedStats.Easy || 0}</div>
          </div>

          {/* Medium */}
          <div className="bg-gradient-to-br from-yellow-500/10 to-yellow-600/5 dark:from-yellow-500/20 dark:to-yellow-600/10 border border-yellow-500/20 dark:border-yellow-500/30 rounded-xl p-6 shadow-md hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <div className="w-3 h-3 rounded-full bg-yellow-500" />
              <span className="text-sm text-gray-600 dark:text-gray-400">Solved Medium</span>
            </div>
            <div className="text-3xl font-bold text-yellow-600 dark:text-yellow-400">{combinedStats.Medium || 0}</div>
          </div>

          {/* Hard */}
          <div className="bg-gradient-to-br from-red-500/10 to-red-600/5 dark:from-red-500/20 dark:to-red-600/10 border border-red-500/20 dark:border-red-500/30 rounded-xl p-6 shadow-md hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <div className="w-3 h-3 rounded-full bg-red-500" />
              <span className="text-sm text-gray-600 dark:text-gray-400">Solved Hard</span>
            </div>
            <div className="text-3xl font-bold text-red-600 dark:text-red-400">{combinedStats.Hard || 0}</div>
          </div>

          {/* Active Days */}
          <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/5 dark:from-blue-500/20 dark:to-blue-600/10 border border-blue-500/20 dark:border-blue-500/30 rounded-xl p-6 shadow-md hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <div className="w-3 h-3 rounded-full bg-blue-500" />
              <span className="text-sm text-gray-600 dark:text-gray-400">Total Active Days</span>
            </div>
            <div className="text-3xl font-bold text-blue-600 dark:text-blue-400">{combinedStats.ActiveDays || 0}</div>
          </div>
        </motion.div>
            ...
            <motion.button
              ...
              className={`rounded-full px-6 py-3 text-sm font-semibold border transition-all duration-300 shadow-md hover:shadow-lg
                ${selectedPlatform === key
                  ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white border-transparent ring-2 ring-offset-2 ring-blue-400'
                  : 'bg-white dark:bg-zinc-900 text-gray-900 dark:text-white border-gray-300 dark:border-gray-700 hover:ring-2 hover:ring-blue-400'
                }`}
        ...
        <div className="mb-6 flex justify-center">
          <div className="w-full max-w-xs">
            ...
            <div className="relative">
              <input
                type="text"
                value={selectedPlatform ? usernames[selectedPlatform] || '' : ''}
                onChange={(e) => {
                  if (selectedPlatform) {
                    handleChange(selectedPlatform, e.target.value);
                  }
                }}
                className="w-full px-4 py-2 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-zinc-800 text-gray-900 dark:text-white text-center focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div className="flex justify-center">
          <button
            ...
            disabled={loading}
            className={`max-w-xs px-5 py-2 rounded-full font-semibold flex items-center justify-center gap-2 transition-all duration-300
              ${loading
                ? 'bg-gradient-to-r from-gray-500 to-gray-600 cursor-not-allowed'
                : 'bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700'
              }
              text-white mb-12 shadow-lg hover:shadow-xl`}
          >
            {loading && (
              <svg
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-2">
          {Object.entries(stats).map(([platform, stat]) => {
            ...
            return (
              <motion.div
                key={platform}
                className="bg-white/70 dark:bg-zinc-900/70 border border-gray-200 dark:border-zinc-800 p-6 rounded-xl shadow-md hover:shadow-xl hover:scale-[1.02] transition-all backdrop-blur-lg"
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-5 rounded-lg bg-gradient-to-br from-green-500/10 to-green-600/5 dark:from-green-500/20 dark:to-green-600/10 border border-green-500/20 dark:border-green-500/30 text-center">
                    ...
                    <p className="text-2xl font-bold text-green-600 dark:text-green-400">{stat.Easy || 0}</p>
                  </div>
                  ...
                  <div className="p-5 rounded-lg bg-gradient-to-br from-yellow-500/10 to-yellow-600/5 dark:from-yellow-500/20 dark:to-yellow-600/10 border border-yellow-500/20 dark:border-yellow-500/30 text-center">
                    ...
                    <p className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{stat.Medium || 0}</p>
                  </div>
                  ...
                  <div className="p-5 rounded-lg bg-gradient-to-br from-red-500/10 to-red-600/5 dark:from-red-500/20 dark:to-red-600/10 border border-red-500/20 dark:border-red-500/30 text-center">
                    ...
                    <p className="text-2xl font-bold text-red-600 dark:text-red-400">{stat.Hard || 0}</p>
                  </div>
                  ...
                  <div className="p-5 rounded-lg bg-gradient-to-br from-blue-500/10 to-blue-600/5 dark:from-blue-500/20 dark:to-blue-600/10 border border-blue-500/20 dark:border-blue-500/30 text-center">
                    ...
                    <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{stat.ActiveDays || 0}</p>
                  </div>
                </div>
              </motion.div>
            );
