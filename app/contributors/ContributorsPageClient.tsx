  ...
  <nav className="flex justify-start m-2" aria-label="Breadcrumb">
    ...
    <li>
      <div className="flex items-center">
        ...
        <a href="#" className="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Community</a>
      </div>
    </li>
    <li aria-current="page">
      <div className="flex items-center">
        ...
        <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Contributors</span>
      </div>
    </li>
  </ol>
</nav>
