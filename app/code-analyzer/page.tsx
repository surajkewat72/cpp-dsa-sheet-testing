        ...
        <div className="text-center space-y-6 py-12">
          ...
          <div className="space-y-4">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
              Code <span className="text-blue-500 dark:text-blue-400">Analyzer</span>
            </h1>
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full bg-white dark:bg-gray-700/50 border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent backdrop-blur-sm appearance-none cursor-pointer transition-all duration-300 hover:bg-gray-50 dark:hover:bg-gray-700/70 shadow-sm dark:shadow-none"
                >
                  {languages.map(l => (
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              <textarea
                ...
                rows={16}
                className="w-full bg-gray-50 dark:bg-gray-900/80 border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-4 font-mono text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent backdrop-blur-sm min-h-[400px] transition-all duration-300 hover:bg-gray-100/50 dark:hover:bg-gray-900/90 placeholder-gray-500 dark:placeholder-gray-500 resize-none shadow-sm dark:shadow-none"
    ...
    return -1;
        ...
        {result && (
          <div className="bg-white/70 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-xl shadow-xl p-8 space-y-6 animate-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Time Complexity */}
              <div className="bg-blue-50/50 dark:bg-gray-700/30 border border-blue-200/50 dark:border-gray-600/50 rounded-lg p-6 hover:bg-blue-50/80 dark:hover:bg-gray-700/50 transition-all duration-300 shadow-sm dark:shadow-none">
            ...
            {/* AI Explanation */}
            {result.explanation && (
              <details className="group bg-gray-50/50 dark:bg-gray-700/20 rounded-lg border border-gray-200/50 dark:border-gray-600/50 transition-all duration-300 hover:bg-gray-50/80 dark:hover:bg-gray-700/30 open:bg-gray-50/80 dark:open:bg-gray-700/30">
                <summary className="font-semibold text-gray-800 dark:text-gray-200 p-6 cursor-pointer list-none flex justify-between items-center group-hover:text-gray-900 dark:group-hover:text-white transition-colors">
                  <div className="flex items-center gap-3">
                    <Brain className="w-5 h-5 text-blue-500 dark:text-blue-400" />
                    <span>AI Explanation</span>
                  </div>
                  <ChevronDown className="w-5 h-5 transition-transform duration-300 group-open:rotate-180 text-gray-500 dark:text-gray-400" />
                </summary>
                <div className="px-6 pb-6 border-t border-gray-200/50 dark:border-gray-600/50">
                  <div className="bg-gray-100/50 dark:bg-gray-900/50 rounded-lg p-4 mt-4">
